...
class _FakeWinreg:
    ...
    def CreateKeyEx(self, root, path, *args, **kwargs):
        self.keys.setdefault((root, path), {"values": {}})
...
def test_install_creates_a_verb_for_every_registered_pair(fake_winreg, fake_proteus_exe):
    ...
    for from_ext, to_ext in CONVERTER_REGISTRY:
        ...
        shell_path = (
            ...
            f"\\shell\\proteus_convert_to_{to_ext}"
        )
...
def test_uninstall_after_install_leaves_zero_keys(fake_winreg, fake_proteus_exe):
